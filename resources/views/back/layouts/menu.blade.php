<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('makale')}}">Tüm Makaleler</a>
                        <a class="collapse-item" href="{{route('makale_creat')}}">Makale Oluştur</a>
                    </div>
                </div>
            </li>
            <!-- Kategoriler -->
            ...
            <li class="nav-item">
                ...
                <div id="collapsePage" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('page_index')}}">Tüm Sayfalar</a>
                        <a class="collapse-item" href="{{route('page_creat')}}">Sayfa Oluştur</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('config_index')}}">
